...
const BranchManagementModalComponent = ({ isOpen, onClose }) => {
  useEffect(() => {
      ...
      <div className="modal-content">
        <div className="flex flex-col items-center justify-center">
          <div className="border-b border-lineColor w-full flex justify-center">
            <p className="text-2xl font-medium my-3">ຈັດການຂໍ້ມູນສາຂາ ແລະ ລູກຄ້າປະຈຳ</p>
          </div>
          <div className="w-full my-5 flex px-10">
            <div className="w-1/3 ">
              <div className="w-full border border-lineColor p-5 rounded-md">
                <p className="text-xl">ຊື່ ແລະ ນາມສະກຸນ</p>
                ...
                <p className="text-xl mt-4">ເບີໂທ</p>
                <div className="w-full border border-lineColor rounded-md my-2 flex justify-center items-center">
                  <input
                    className="w-full py-2 px-5 rounded text-center"
                    id="price"
                ...
                <p className="text-xl mt-4">ເລືອກລາຄາ</p>
                <CustomDropdown
                  options={unitData}
                  selectedOption={selectedUnit}
                  onSelect={setSelectedUnit}
                />
                 <p className="text-xl mt-4">ລາຍລະອຽດ</p>
                <div className="w-full border border-lineColor rounded-md my-2 flex justify-center items-center">
                  <input
                    className="w-full py-2 px-5 rounded text-center"
                    id="price"
            ...
            <div className="w-2/3 ml-10 h-[600px] border border-lineColor py-3 rounded-md flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-center px-5">
                  <p className="text-xl w-1/3">ຂໍ້ມູນສາຂາ ແລະ ລູກຄ້າປະຈຳ</p>
                ...
                <div className="border border-lineColor w-full py-3 mt-3 bg-bgHead flex justify-between items-center px-5 ">
                  ...
                  <p className="text-base font-light w-1/4">ຊື່ ແລະ ນາມສະກຸນ</p>
                  <p className="text-base font-light w-1/6">ເບີໂທ</p>
                  <p className="text-base font-light w-1/6">ລາຄາ</p>
                ...
                {currentItems.map((item) => (
                  <div className="w-full pt-3 pb-5 mt-3 mb-1 bg-white flex justify-between items-center px-5 border-b border-lineColor">
                    ...
                    <p className="text-base font-light w-1/6">{item.phone}</p>
                    <p className="text-base font-light w-1/6">{item.price}</p>
...
export default BranchManagementModalComponent;
