...
const PriceManagementModalComponent = ({ isOpen, onClose }) => {
    useEffect(() => {
                    ...
                    <div className="w-full my-5 flex px-10">
                        <div className="w-1/3 ">
                            <div className="w-full border border-lineColor p-5 rounded-md">
                                ...
                                <p className="text-xl mt-4">ລາຄາ</p>
...
export default PriceManagementModalComponent;
